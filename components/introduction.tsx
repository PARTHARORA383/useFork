  ...
  return (
    <div className="w-full lg:max-w-3xl flex flex-col items-start px-4 lg:px-0">
      ...
      <p className="lg:text-xl leading-relaxed tracking-wide">
        useFork is a Next.js UI component library featuring reimagined web components, from minimal
        designs to interactive elements, built with Motion and TailwindCSS.
      </p>
    </div>
  );
}
      ...
      <section className="">
        ...
        <div className="flex justify-center items-center gap-12">
          <img
            ...
            alt="Tailwind css"
            src="https://dqbr6kzn27lfn.cloudfront.net/logos/tailwind.svg"
...
const NextJSLogo = (
  ...
  >
    ...
    <g mask="url(#_S_1_mask0_408_134)">
      <circle cx="90" cy="90" data-circle="true" fill="black" r="90"></circle>
      <path
        d="M149.508 157.52L69.142 54H54V125.97H66.1136V69.3836L139.999 164.845C143.333 162.614 146.509 160.165 149.508 157.52Z"
        fill="url(#_S_1_paint0_linear_408_134)"
      ></path>
      <rect fill="url(#_S_1_paint1_linear_408_134)" height="72" width="12" x="115" y="54"></rect>
    </g>
    <defs>
      <linearGradient
        gradientUnits="userSpaceOnUse"
        id="_S_1_paint0_linear_408_134"
        x1="109"
        x2="144.5"
        y1="116.5"
        y2="160.5"
...
const motionLogo = (
  <svg className="h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1103 386">
    <path
      fill="#FFF312"
