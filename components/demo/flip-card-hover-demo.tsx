...
function Back() {
  return (
    <div className="w-full h-full bg-amber-50 rounded-xl p-6 flex flex-col justify-between">
      <div>
        <p className="font-serif font-medium text-black mb-4 text-[17px]">Welcome to our Journey</p>
        <span className=" text-black font-serif font-medium">
          useFork began as a simple idea — to bridge the gap between design and development, so
          creators could spend less time fighting UI and more time building what matters
        </span>
      </div>
