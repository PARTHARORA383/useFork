...
function InstallationTabTrigger({
  className,
  ...props
...
interface InstallationContentProps extends React.ComponentProps<typeof TabsPrimitive.Content> {
  yOffset?: number;
  blurAmount?: number;
  duration?: number;
  children: string;
