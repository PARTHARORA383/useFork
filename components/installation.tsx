...
export function Installation({ command }: InstallationProps) {
  ...
  return (
    <div className="lg:min-w-3xl max-w-3xl border rounded-xl overflow-x-auto no-scrollbar shadow-sm">
      <AnimatedTabs defaultValue="npm" className=''>
        <AnimatedTabsList className="border-b  gap-4 bg-muted rounded-t-xl px-2 py-1">
        ...
        {Object.entries(baseCommands).map(([key, base]) => (
          <AnimatedTabsContent key={key} value={key} className="relative px-8 py-2">
