...
export function FlipCardOnHover({
  ...
  const defaultFront = (
    <div className="relative w-full h-full rounded-xl overflow-hidden flex items-center justify-center">
      ...
      <img src={defaultFrontImage} alt="Front" className="w-full h-full object-cover rounded-xl" />
  ...
  const defaultBack = (
    <div className="w-full h-full bg-amber-50 rounded-xl p-6 flex flex-col justify-between">
      <div>
        <p className="font-serif font-medium text-black mb-2">{defaultHeading}</p>
