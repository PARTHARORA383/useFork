      ...
      <AnimatePresence>
        {active && (
          <div>
            ...
            <div
              className="fixed top-5 left-6 z-60 overflow-hidden cursor-pointer"
              onClick={() => {
                setActive(false);
              }}
            >
            ...
            <div
              className="fixed top-5 right-5 z-60 overflow-hidden cursor-pointer"
              onClick={() => {
                setActive(false);
              }}
            >
      ...
      <AnimatePresence>
        {active && (
          <Link
            ...
            href={href}
            key={active ? `enter-${text}` : `exit-${text}`}
          >
            <motion.div
              key={active.toString()}
