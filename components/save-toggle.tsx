      ...
      <AnimatePresence mode="wait">
        {state === "idle" && (
          <motion.div
            ...
            className={cn('flex items-center border  justify-center p-2 px-4 overflow-hidden font-medium rounded-full  shadow-[inset_2px_2px_5px_rgba(0,0,0,0.1),inset_-2px_-2px_5px_rgba(255,255,255,0.7)] dark:shadow-[inset_4px_4px_6px_rgba(0,0,0,0.7),inset_-2px_-2px_3px_rgba(255,255,255,0.1)] ', className)}
          >
            {text.map((char, index) => (
              <motion.span
                key={index}
        ...
        {state === "completed" && (
          <motion.div
            ...
            className={cn('flex items-center justify-center py-2 overflow-hidden rounded-full px-4 border border-muted shadow-[inset_2px_2px_5px_rgba(0,0,0,0.1),inset_-2px_-2px_5px_rgba(255,255,255,0.7)] dark:shadow-[inset_4px_4px_6px_rgba(0,0,0,0.7),inset_-2px_-2px_3px_rgba(255,255,255,0.1)] ', className)}
          >
